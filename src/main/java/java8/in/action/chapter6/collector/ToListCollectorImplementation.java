 ...
 */
public class ToListCollectorImplementation<T> implements Collector<T, List<T>, List<T>> {
	/**
	 * The actual collector provided by the Java API uses the Collections.emptyList() singleton
	 * when it has to return an empty list.
	 *
	 * @return
	 */
